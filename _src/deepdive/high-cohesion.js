// Deep-dive content for High Cohesion (GRASP). ONE FILE PER CONCEPT.
...
module.exports = {
  ...
  framing: `Cohesion measures how related a class's responsibilities are. High cohesion means every method and field pulls toward a single, clear purpose; low cohesion is a grab-bag of unrelated duties sharing a class only by accident.`,
  why: `Cohesive classes are easier to name, understand, test, and reuse, and they change for fewer reasons. Low cohesion spreads one concept across many edits and invites coupling, because unrelated duties drag in unrelated dependencies.`,
